...
RSpec.describe "merchant bulk discounts new page", type: :feature do
  ...
  describe 'As a merchant, When I visit my bulk discounts index' do
    ...
    it 'When I fill in the form with valid dataThen I am redirected back to the bulk discount index And I see my new bulk discount listed' do
    ...
    it "I am redirected back to the new page and I am informed via flash message that I entered incorrect information." do
      visit new_merchant_bulk_discount_path(1)
